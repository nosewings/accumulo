...
-->
      ...
      <div class="row">
        <div class="col-md-6 offset-sm-3" id="manager">
          <table class="table table-bordered table-striped table-sm">
            <thead>
              <tr><th colspan="2"><a href="/manager">Accumulo Manager</a></th></tr>
              <tr><td colspan="2" class="center" style="display:none;"><span class="badge badge-danger nowrap">Manager is Down</span></td></tr>
