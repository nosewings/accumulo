...
-->
      ...
      <div class="row">
        <div class="col-12">
          <table id="badtservers" class="table table-bordered table-striped table-sm">
          ...
          <table id="deadtservers" class="table table-bordered table-striped table-sm">
          ...
          <table id="tservers" class="table table-bordered table-striped table-sm">
